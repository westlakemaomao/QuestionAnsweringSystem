...
public class TextualAlignmentCandidateAnswerScore implements CandidateAnswerScore {
	...
	// for (CandidateAnswer candidateAnswer :
	// candidateAnswerCollection.getAllCandidateAnswer()) {
	// // 3、计算候选答案的文本对齐
	...
	// }
	// // 4、演化为多个模式，支持模糊匹配
	// List<Word> textualAlignmentPatternTerms =
	// Tools.getWords(textualAlignmentPattern);
...
//			System.out.println("candidateAnswer.getAnswer():"+candidateAnswer.getAnswer());
			candidateAnswer.addScore(1.0);
